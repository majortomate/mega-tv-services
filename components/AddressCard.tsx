function AddressCard () {
  return (
    <div className="bg-gray-200 rounded-lg shadow-lg p-5 grid-cols-5 grid items-center m-2">
        <div className="col-span-4">
          <p className="font-bold text-blue-700">Magnolia Dumbo</p>
          <p>185 NYC, Broolyn, YN 1220</p>
        </div>
